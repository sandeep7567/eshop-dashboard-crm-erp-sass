...
const PrivateRoutes = () => {
  return (
    <section id="page" className="bg-global w-full font-[Nunito,sans-serif,sans]">
      <nav
      ...
      <main className="card-shadow bg-white max-w-xl mx-auto -ml-24 md:max-w-5xl w-full rounded-lg md:mx-auto px-4 py-8 mt-7">
        {/* <Card className=""> */}
          <Outlet />
        {/* </Card> */}
      </main>
